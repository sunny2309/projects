...
table1 = html.Table(
            [
            html.Tr(
                [html.Td(" HEALTHY ", style={"background-color":"green", "text-align":"center", "color":"white", "padding":"2px","border": "1px solid white", "font-weight":"bold", "width": "50%"}),
                html.Td("UNHEALTHY", style={"background-color":"red", "text-align":"center","color":"white",  "padding":"2px","border": "1px solid white", "font-weight":"bold", "width": "50%"})
                ]),
            html.Tr(
                [
                html.Td("%.1f%%"%(healthy_unhealthy_cnt["Healthy"]*100/well_integrity.shape[0]), style={"background-color":"green", "text-align":"center", "color":"white", "padding":"2px", "border": "1px solid white", "font-weight":"bold"}),
                html.Td("%.1f%%"%(healthy_unhealthy_cnt["Unhealthy"]*100/well_integrity.shape[0]), style={"background-color":"red", "text-align":"center","color":"white", "padding":"2px", "border": "1px solid white", "font-weight":"bold"})
                ]),
            html.Tr(
                [
                html.Td("%d"%healthy_unhealthy_cnt["Healthy"], style={"background-color":"green", "text-align":"center", "color":"white","padding":"2px", "border": "1px solid white", "font-weight":"bold"}),
                html.Td("%d"%healthy_unhealthy_cnt["Unhealthy"], style={"background-color":"red", "text-align":"center","color":"white", "padding":"2px", "border": "1px solid white", "font-weight":"bold"})
                ]),
            html.Tr(
                [
                html.Td("Strings", style={"background-color":"green", "text-align":"center", "color":"white", "padding":"2px", "border": "1px solid white", "font-weight":"bold"}),
                html.Td("Strings", style={"background-color":"red", "text-align":"center","color":"white", "padding":"2px", "border": "1px solid white", "font-weight":"bold"})
                ]),
...
table2 = html.Table(
            ...
            html.Tr(
                [
                html.Td(children="P1- Serious", style={"background-color":"red", "text-align":"center","padding":"2px", "border": "1px solid white", "font-weight":"bold", "width": "70%"}),
                html.Td(unhealthy_cat_dist["P1- Serious"], style={"border": "1px solid white", "text-align":"center", "padding":"2px", "font-weight":"bold", "width": "30%"})
                ]),
            html.Tr(
                [
                html.Td("P2 - MOC", style={"background-color":"orange", "text-align":"center", "padding":"2px", "border": "1px solid white", "font-weight":"bold"}),
                html.Td(unhealthy_cat_dist["P2 - MOC"], style={"border": "1px solid white", "text-align":"center", "padding":"2px", "font-weight":"bold"})
                ]),
            html.Tr(
                [
                html.Td("P2 - Exceed Limit", style={"background-color":"orange", "text-align":"center", "padding":"2px", "border": "1px solid white", "font-weight":"bold"}),
                html.Td(unhealthy_cat_dist["P2 - Exceed Limit"], style={"border": "1px solid white", "text-align":"center", "padding":"2px", "font-weight":"bold"})
                ]),
            html.Tr(
                [html.Td("P3-Within Limit", style={"background-color":"yellow", "text-align":"center", "padding":"2px", "border": "1px solid white", "font-weight":"bold"}),
                html.Td(unhealthy_cat_dist["P3-Within Limit"], style={"border": "1px solid white", "text-align":"center", "padding":"2px", "font-weight":"bold"})
                ]),
            html.Tr(
                [html.Td("Intact", style={"background-color":"green", "text-align":"center", "padding":"2px", "border": "1px solid white", "font-weight":"bold"}),
                html.Td(unhealthy_cat_dist["Intact"], style={"border": "1px solid white", "text-align":"center", "padding":"2px", "font-weight":"bold"})
                ]),
           ], style={"justify-content":"center", "align-items": "center", "float": "center", "width": "100%"})
...
row1 = html.Div(children=[html.Div([html.Br(),
                                    html.Br(),
                                    html.H5("MALAYSIA WELLS HEALTHINESS", style={"color":"gold", "font-weight":"bold"}),
                                    ...
                                    html.Div(table1, style={"justify-content":"center", "align-items": "center"})], className="two columns"),
                                    html.Div(graph1, className="five columns"),
                                    html.Div(graph2, className="five columns")])

row2 = html.Div(children=[html.Div([html.Br(),
                                    html.Br(),
                                    html.H5("UNHEALTHY STRINGS", style={"color":"gold", "font-weight":"bold"}),
                                    html.Hr(style={"margin":"0px", "padding":"0px"}),
                                    ...
                                    html.H4("%d Strings"%np.sum([unhealthy_cat_dist["P1- Serious"],
                                                                 ...
                                                                 unhealthy_cat_dist["P2 - Exceed Limit"]]), style={"color":"orange", "font-weight":"bold"}),
                                    html.Div(table2, style={"justify-content":"center", "align-items": "center"})], className="two columns"),
                                    html.Div(graph3, className = "five columns"),
                                    html.Div(graph4, className = "five columns")])

layout = html.Div(children=[html.Img(src="static/RTI_Logo.jpeg", style={"width":"75x", "height":"75px", "margin":"0px", "padding":"0px"}),header, row1, row2], style={"text-align": "center", })
