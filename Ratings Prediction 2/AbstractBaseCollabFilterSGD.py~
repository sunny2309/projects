...
class AbstractBaseCollabFilterSGD(object):
    ...
    def fit(self, train_data_tuple, valid_data_tuple=None):
        ...
        self.trace_mse_train = []
        self.trace_mse_valid = []
        ...
        for epoch_count in range(self.n_epochs): 
            ...
            for i, batch_tuple in enumerate(batch_loader):
                ...
                if do_report_now:
                    ...
                    self.trace_mse_train.append(train_perf_dict['mse'])
                    self.trace_mse_valid.append(valid_perf_dict['mse'])
                    ...
                    print("epoch %11.3f | loss_total % 11.5f | train_MSE % 11.5f | valid_MSE % 11.5f | %s" % (
                        epoch, loss if epoch <= 2 else smooth_loss,
                        train_perf_dict['mse'], valid_perf_dict['mse'],
                        avg_grad_norm_str))
